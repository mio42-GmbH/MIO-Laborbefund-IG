...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <sch:pattern>
    ...
    <sch:rule context="f:DiagnosticReport">
      ...
      <sch:assert test="count(f:extension[@url = 'https://fhir.kbv.de/StructureDefinition/KBV_EX_MIO_LAB_Order_Entry_Time']) &lt;= 1">extension with URL = 'https://fhir.kbv.de/StructureDefinition/KBV_EX_MIO_LAB_Order_Entry_Time': maximum cardinality of 'extension' is 1</sch:assert>
      <sch:assert test="count(f:extension[@url = 'https://fhir.kbv.de/StructureDefinition/KBV_EX_MIO_LAB_Pseudonymized_Report']) &lt;= 1">extension with URL = 'https://fhir.kbv.de/StructureDefinition/KBV_EX_MIO_LAB_Pseudonymized_Report': maximum cardinality of 'extension' is 1</sch:assert>
      <sch:assert test="count(f:extension[@url = 'https://fhir.kbv.de/StructureDefinition/KBV_EX_MIO_LAB_Critical_Result']) &lt;= 1">extension with URL = 'https://fhir.kbv.de/StructureDefinition/KBV_EX_MIO_LAB_Critical_Result': maximum cardinality of 'extension' is 1</sch:assert>
      <sch:assert test="count(f:extension[@url = 'https://fhir.kbv.de/StructureDefinition/KBV_EX_MIO_LAB_Secondary_Status']) &lt;= 3">extension with URL = 'https://fhir.kbv.de/StructureDefinition/KBV_EX_MIO_LAB_Secondary_Status': maximum cardinality of 'extension' is 3</sch:assert>
  ...
  <sch:pattern>
    <sch:title>f:DiagnosticReport/f:extension/f:value[x] 1</sch:title>
  ...
  <sch:pattern>
    ...
    <sch:rule context="f:DiagnosticReport/f:result">
      <sch:assert test="count(f:id) &lt;= 1">id: maximum cardinality of 'id' is 1</sch:assert>
      <sch:assert test="count(f:extension[@url = 'https://fhir.kbv.de/StructureDefinition/KBV_EX_MIO_LAB_Sorting_Number']) &gt;= 1">extension with URL = 'https://fhir.kbv.de/StructureDefinition/KBV_EX_MIO_LAB_Sorting_Number': minimum cardinality of 'extension' is 1</sch:assert>
      <sch:assert test="count(f:extension[@url = 'https://fhir.kbv.de/StructureDefinition/KBV_EX_MIO_LAB_Sorting_Number']) &lt;= 1">extension with URL = 'https://fhir.kbv.de/StructureDefinition/KBV_EX_MIO_LAB_Sorting_Number': maximum cardinality of 'extension' is 1</sch:assert>
      <sch:assert test="count(f:reference) &gt;= 1">reference: minimum cardinality of 'reference' is 1</sch:assert>
      <sch:assert test="count(f:reference) &lt;= 1">reference: maximum cardinality of 'reference' is 1</sch:assert>
      <sch:assert test="count(f:type) &lt;= 0">type: maximum cardinality of 'type' is 0</sch:assert>
      <sch:assert test="count(f:identifier) &lt;= 0">identifier: maximum cardinality of 'identifier' is 0</sch:assert>
  ...
  <sch:pattern>
    <sch:title>f:DiagnosticReport/f:result/f:extension</sch:title>
  ...
  <sch:pattern>
    <sch:title>f:DiagnosticReport/f:media/f:link/f:extension</sch:title>
  ...
  <sch:pattern>
    <sch:title>f:DiagnosticReport/f:media/f:link/f:extension/f:value[x] 1</sch:title>
    <sch:rule context="f:DiagnosticReport/f:media/f:link/f:extension/f:value[x]">
      <sch:assert test="count(f:id) &lt;= 1">id: maximum cardinality of 'id' is 1</sch:assert>
      <sch:assert test="count(f:reference) &gt;= 1">reference: minimum cardinality of 'reference' is 1</sch:assert>
      <sch:assert test="count(f:reference) &lt;= 1">reference: maximum cardinality of 'reference' is 1</sch:assert>
      <sch:assert test="count(f:type) &lt;= 0">type: maximum cardinality of 'type' is 0</sch:assert>
