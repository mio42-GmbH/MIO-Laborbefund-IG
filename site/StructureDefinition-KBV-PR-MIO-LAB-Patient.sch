...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <sch:pattern>
    ...
    <sch:rule context="f:Patient/f:extension">
      ...
      <sch:assert test="count(f:extension[@url = 'supportingInfo']) &lt;= 0">extension with URL = 'supportingInfo': maximum cardinality of 'extension' is 0</sch:assert>
      <sch:assert test="count(f:extension[@url = 'intendedClinicalUse']) &lt;= 0">extension with URL = 'intendedClinicalUse': maximum cardinality of 'extension' is 0</sch:assert>
  ...
  <sch:pattern>
    <sch:title>f:Patient/f:gender/f:extension/f:value[x] 1</sch:title>
